jQuery(document).ready(function($){
  ...
  function mobileMenuCollapse() {
    ...
    var menus = $('nav .block-menu, #block-menu-menu-campus-tools-suite-222-').not('.region-off-screen-overlay .block-menu');
    ...
    menus.each(function() {
      ...
      switch (id) {
        ...
        default:
          ...
          if ( id == 'block-menu-menu-campus-tools-suite-222-') {
    ...
    var searchbox = $('.region-top-nav form.google-cse');
